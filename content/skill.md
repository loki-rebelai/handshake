...
1. Read [SDK Installation](skills/sdk-install.md) to set up the SDK
2. Use [Faucet](skills/faucet.md) to fund your wallet on testnet
3. Use [Payments](skills/payments.md) to send your first escrow payment

## Documentation

- [Architecture](docs/architecture.md): How the escrow protocol works
- [API Reference](docs/api-reference.md): All REST endpoints
- [Error Codes](reference/errors.md): Troubleshooting
